    ...
    ***************************************************************************** */
    ...
    var IonTextarea = /** @class */ (function () {
        ...
        IonTextarea = __decorate([
            ...
            core.Component({ selector: 'ion-textarea', changeDetection: core.ChangeDetectionStrategy.OnPush, template: '<ng-content></ng-content>', inputs: ['autoGrow', 'autocapitalize', 'autofocus', 'clearOnEdit', 'color', 'cols', 'debounce', 'disabled', 'maxlength', 'minlength', 'mode', 'name', 'placeholder', 'readonly', 'required', 'rows', 'spellcheck', 'value', 'wrap'] })
        ], IonTextarea);
        return IonTextarea;
    }());
    ...
    var GestureController = /** @class */ (function () {
         ...
         */
        GestureController.prototype.create = function (opts) {
            return core$1.createGesture(opts);
        };
        GestureController.ngInjectableDef = core.ɵɵdefineInjectable({ factory: function GestureController_Factory() { return new GestureController(); }, token: GestureController, providedIn: "root" });
