...
import 'package:flutter_login/src/helper/quad_clipper.dart';
import 'recomended_page.dart';
import 'package:flutter_login/src/theme/color/light_color.dart';
        ...
        child: Row(
          ...
          children: <Widget>[
            _card(
                ...
                chipText1: "Pneumonia Bacterial cases",
                chipText2: "3 Comments",
                isPrimaryCard: true,
                imgPath:
            ...
            _card(
                ...
                chipText1: "How to check X-RAY opacity",
                chipText2: "8 Comments",
                imgPath:
            ...
            _card(
                ...
                chipText1: "Will Cheta Solve this ?",
                chipText2: "12 Comments",
                imgPath:
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        bottomNavigationBar: BottomNavigationBar(
          ...
          currentIndex: 0,
          items: [
            _bottomIcons(Icons.rate_review),
            _bottomIcons(Icons.add_a_photo),
            _bottomIcons(Icons.book),
            _bottomIcons(Icons.person),
          ],
          onTap: (index) {
            print("INDEX RAW LENA ");  print(index);
        ...
        body: SingleChildScrollView(
          ...
          child: Column(
            children: <Widget>[
              _header(context),
              SizedBox(height: 20),
              _categoryRow("Featured", LightColor.orange, LightColor.darkBlue),
              _featuredRowA(),
              SizedBox(height: 0),
              _categoryRow(
                  "Featured", LightColor.purple, LightColor.darkgrey),
              _featuredRowB()
            ],
          ),
        )));
